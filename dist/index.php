...
$sql = "SELECT crop FROM user_crops WHERE user_id = $id";
$result = $conn->query($sql);
$crops = []; 
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
    ...
    $cropss = implode(", ", $crops);
} else {
    $crops = ["NOT GROWN ANY"];
}

$sql = "SELECT COUNT(*) AS row_count FROM company_signup";
$result = $conn->query($sql);
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./assets/index-0b6b1706.css">
  </head>
  <body>
    <style>
        .img
  ...
  <li>
                    ...
                    >
                      ...
                      >
                       ...
                       <span class="ml-4">Connect to experts</span> 
                    </a>
                  </li>
        ...
        <main class="relative flex-1 overflow-y-auto focus:outline-none">
          <div class="py-6">
            <div class="px-4 mx-auto max-w-7xl sm:px-6 md:px-8">
              <div>
                <h1 class="text-2xl flex justify-center" >Welcome <?php echo $name?>..!</h1>
              </div>
            </div>
            <div class="px-4 mx-auto max-w-7xl sm:px-6 md:px-8">
                <!-- main content -->
              <div class="bg-blue-300  rounded md w-full h-20 mt-5 flex " >
                    <h1 class="font-semibold text-lg px-12 py-6 ">Companies</h1>
                    <h1 class="font-bold text-lg px-12 py-6 "><?php echo  $rowCount ; ?></h1>
              </div>
              <div class="bg-blue-300  rounded md w-full h-20 my-1 flex " >
                    <h1 class="font-semibold text-lg px-12 py-6 ">Crops Grown </h1>
                    
                    <h1 class="font-bold text-lg px-12 py-6 "><?php echo $cropss ?></h1>
              </div>
              <div class="bg-blue-300  rounded md w-full h-20 my-1 flex " >
                    <h1 class="font-semibold text-lg px-12 py-6 ">Account Balance</h1>
                    <h1 class="font-bold text-lg px-12 py-6 "> <?php echo $bal?></h1>
              </div>
              <div class="bg-blue-300  rounded md w-full h-20 my-1 flex " >
                    <h1 class="font-semibold text-lg px-12 py-6 ">New Orders</h1>
                    <h1 class="font-bold text-lg px-12 py-6 "> <?php echo $ordes ?></h1>
              </div>
              <div class="py-4">
