...
$conn = new mysqli($servername, $username, $password1, $dbname);
    if ($conn->connect_error) {
        ...
        $sql = "SELECT * FROM company_signup WHERE email = '$email'";
        $result = $conn->query($sql);

        if ($result->num_rows > 0) {
    // Output data of each row
     while ($row = $result->fetch_assoc()) {    
        $cname1 = $row["company_name"]; 
...
<head>
    ...
    <title>User</title>
  <link rel="stylesheet" href="./assets/index-dd8c0a58.css">
</head>
<body>
    <header
  ...
  >
    ...
    <a
      ...
      aria-label="logo"
    >
    <img src="./assets/logo-bca06472.png" alt="logo"
    width="100"
        height="100"
        viewBox="0 0 100 100"
              ...
              <nav class="flex-1 space-y-1 bg-indigo-700">
                ...
                -->
                  <li>
                    <a
                      class="inline-flex items-center w-full px-4 py-2 mt-1 text-base text-white transition duration-500 ease-in-out transform border-indigo-800 rounded-lg hover:border-indigo-800 focus:shadow-outline hover:bg-indigo-600"
                      href="../dash final output/UserPagefolder/index.php"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="w-4 h-4"
        ...
        <main class="relative flex-1 overflow-y-auto focus:outline-none">
          <div class="py-6">
            <div class="px-4 mx-auto max-w-7xl sm:px-6 md:px-8">
              <div>
                <h1 class="text-2xl flex justify-center" >Welcome <?php echo $cname1?>!</h1>
              </div>
            </div>
            <div class="px-4 mx-auto max-w-7xl sm:px-6 md:px-8">
                <!-- main content -->
                <div class="bg-gray-300  rounded-xl  justify-start md w-[30%] h-20 mt-5 flex">
                   <div  class=" px-4 py-6 flex" ><h1 class="text-stone-950 font-semibold">GSTIN : </h1><h1><?php echo $gstn?></h1></div>
                </div>
              <div class="bg-blue-300  rounded md w-full h-20 mt-5 flex " >
                    <h1 class="font-semibold text-lg px-12 py-6 ">TotalClients</h1>
                    <h1 class="font-bold text-lg px-12 py-6 "><?php echo $rowCount ?> </h1>
              </div>
              <div class="bg-blue-300  rounded md w-full h-20 my-1 flex " >
                    <h1 class="font-semibold text-lg px-12 py-6 ">Expenditure </h1>
                    <h1 class="font-bold text-lg px-12 py-6 "> <?php echo $bal ?> $</h1>
              </div>
              <div class="bg-blue-300  rounded md w-full h-20 my-1 flex " >
                    <h1 class="font-semibold text-lg px-12 py-6 ">New Sales</h1>
                    <h1 class="font-bold text-lg px-12 py-6 "><?php echo $new ?></h1>
              </div>
              <!-- <div class="bg-blue-300  rounded md w-full h-20 my-1 flex " >
                    <h1 class="font-semibold text-lg px-12 py-6 ">New Orders</h1>
                    <h1 class="font-bold text-lg px-12 py-6 "> 0</h1>
              </div> -->
              <!--  -->
              <div class="py-4">
